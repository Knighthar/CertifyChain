...
import './Login_student.css'; // Import the CSS file for styling
...
// Render the Login_student component to the root element in the HTML
const rootElement = document.getElementById("root");
ReactDOM.render(<Login_student />, rootElement);
